...
contract SunUSDT_TRXPool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunUSDT_TRXPool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
        super.withdrawTo(nextPool, userBalance);

        return true;
    }

    function setRewardRate(uint256 newRewardRate) public onlyRewardDistribution {
